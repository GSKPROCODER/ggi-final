      ...
      <AnimatePresence>
        {selectedIds.size > 0 && (
          <motion.div
            ...
            className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-4 bg-card/80 backdrop-blur-xl border border-border px-6 py-4 rounded-2xl shadow-2xl flex-wrap"
            role="region"
